...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-BloodBros_MiSTer.git"
CORE_NAME=(BloodBros)
...
UPSTREAM_CORE_NAME=(BloodBros)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(BloodBros.qpf)
COMPILATION_OUTPUT=(output_files/BloodBros.rbf)
