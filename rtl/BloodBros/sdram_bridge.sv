...
// sdram_bridge — Bridge e arbitro SDRAM per BloodBros.
...
always @(*) begin
	if (download_active) begin
		...
		begin
			...
			reg [23:0] gfx_addr;
			case (gfx_kind)
				3'd0: gfx_base = BG_BASE;     // BG layer
				3'd1: gfx_base = MG_BASE;     // MG layer (disabled in Blood Bros)
				3'd2: gfx_base = BG_BASE;     // FG layer: Blood Bros shares ROM with BG (MAME bloodbro:807-808)
...
// ================================================================
// PORT 2: SDRAM bank 2 — UNUSED (BloodBros ha 1 sola CPU 68k).
